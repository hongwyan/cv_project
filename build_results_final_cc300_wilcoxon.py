...
DEFAULT_INPUT_CSV = DEFAULT_SUMMARY_ROOT / "results_3D_cc300" / "patient_metrics_3d_cc300_by_seed.csv"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Build pooled Wilcoxon test table for cc300 boundary comparisons.")
...
def main():
    ...
    for lhs_model, rhs_model in COMPARISONS:
        for metric in METRICS:
            ...
            stat, pvalue = safe_wilcoxon(lhs_vals[mask], rhs_vals[mask])
            rows.append(
                {
                    "lhs_model": lhs_model,
                    "rhs_model": rhs_model,
    ...
    csv_path = output_dir / "pooled_results_cc300_wilcoxon.csv"
    md_path = output_dir / "pooled_results_cc300_wilcoxon_3sf.md"
