...
DEFAULT_INPUT_CSV = DEFAULT_SUMMARY_ROOT / "results_3D" / "patient_hd95_allmodels_fpr_lt_0_2_by_seed.csv"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build pooled final table from patient_hd95_allmodels_fpr_lt_0_2_by_seed.csv."
    )
...
def main():
    ...
    out_path = output_dir / "pooled_results_allmodels_fpr_lt_0_2.csv"
